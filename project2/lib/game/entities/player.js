...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        animSheet: new ig.AnimationSheet( 'media/newplayer.PNG', 35, 50 ),
        size: {x: 30, y: 42},
        offset: {x: 2, y: 8},
        flip: false,
        maxVel: {x: 100, y: 220},
        ...
        setupAnimation: function(offset){
            ...
            this.addAnim('jump', 1, [4+offset]);
            this.addAnim('fall', 0.4, [3+offset]);
        },
        ...
        update: function() {
            ...
            // shoot
            if (this.activeWeapon == 'EntityBullet' || this.activeWeapon == 'EntityBullets1') {
			if( ig.input.pressed('shoot') ) {
            	if (this.activeWeapon == 'EntityBullets1') {
				ig.game.spawnEntity( EntityBullets3, this.pos.x, this.pos.y, {flip:this.flip} );
				ig.game.spawnEntity( EntityBullets2, this.pos.x, this.pos.y, {flip:this.flip} );
            ...
            if( ig.input.pressed('switch') ) {
                ...
                switch(this.weapon){
                	case(0):
                		...
                		break;
                	case(1):
                		this.activeWeapon = "EntityBulletmg";
						break;
					case(2):
                		this.activeWeapon = "EntityBullets1";
						break;
                }
                //this.setupAnimation(this.weapon);
            }
	...
	EntityBulletmg = ig.Entity.extend({
        size: {x: 5, y: 3},
        animSheet: new ig.AnimationSheet( 'media/bullet.png', 5, 3 ),
        maxVel: {x: 700, y: 0},
        type: ig.Entity.TYPE.NONE,
	...
	EntityBullets1 = ig.Entity.extend({
        size: {x: 5, y: 3},
        animSheet: new ig.AnimationSheet( 'media/bullet.png', 5, 3 ),
        maxVel: {x: 700, y: 100},
        type: ig.Entity.TYPE.NONE,
	...
	EntityBullets2 = ig.Entity.extend({
        size: {x: 5, y: 3},
        animSheet: new ig.AnimationSheet( 'media/bullet.png', 5, 3 ),
        maxVel: {x: 700, y: -100},
        type: ig.Entity.TYPE.NONE,
	...
	EntityBullets3 = ig.Entity.extend({
        size: {x: 5, y: 3},
        animSheet: new ig.AnimationSheet( 'media/bullet.png', 5, 3 ),
        maxVel: {x: 700, y: 0},
        type: ig.Entity.TYPE.NONE,
